    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_type', models.CharField(choices=[('REST', 'Restaurant'), ('HAIR', 'Hair Salon'), ('BARB', 'Barber Shop'), ('ESTH', 'Esthetician'), ('NAIL', 'Nail Salon'), ('DERM', 'Dermatologist'), ('APPL', 'Appliance Repair'), ('LAWY', 'Lawyer'), ('EVEN', 'Event Planner'), ('REAL', 'Realtor'), ('SKIN', 'Skincare'), ('CLOT', 'Clothing')], default='REST', max_length=4)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
